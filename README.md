...
We provide a comparison between the original 10 ambiguous rules and the improved versions generated by GPT-OSS and Llama-4 [Click here to view improved rule examples](Improved Rules.pdf)
