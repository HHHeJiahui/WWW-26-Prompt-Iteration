Here is the **prompt iteration result for each RQ** and **improved rules examples** in WWW '26 paper "Enhancing Content Moderation with LLMs: A Reddit Case Study on Evaluating and Refining Human Decisions".
...
# Improved rule examples
We provide a comparison between the original 10 ambiguous rules and the improved versions generated by GPT-OSS and Llama-4. [Click here to view improved rule examples](Improved_Rules.pdf)
